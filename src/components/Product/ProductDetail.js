  ...
  return (
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container} style={{padding: '10px'}}>
...
<Grid container spacing={3} style={{ height: '100vh' }}>
  <Grid item xs={12} md={6} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '0px' }}>
    {/* Other content */}
  </Grid>
